...
function EditUser(props) {
  ...
  async function editForm() {
    ...
    try {
      const response = await fetch(
        "http://35.197.137.53:10003/profile/" + props.id,
        {
          method: "PATCH",
          body: data,
        }
  ...
  async function uploadImage(e) {
    ...
    await fetch("http://35.197.137.53:10003/profile/img/" + props.id, {
      method: "PATCH",
      body: form,
    });
    props.closeMenu(false);
  ...
  async function getData() {
    const endPoint = "http://35.197.137.53:10003/profile/" + props.id;
