...
function UserList() {
  ...
  async function deleteItem(id) {
    await fetch(`http://35.240.184.74:10003/profile/${id}`, {
      method: "DELETE",
    });
    dataUser();
  }
  ...
  async function filterUsers(e) {
    ...
    const listDataUser = await fetch(
      `http://35.240.184.74:10003/profile?page=${page}&search=${inputSearch}`,
      {}
    );
  ...
  async function dataUser() {
    const endPoint = `http://35.240.184.74:10003/profile`;
